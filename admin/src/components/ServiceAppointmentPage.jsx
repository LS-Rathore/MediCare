...
import { CheckCircle, XCircle, Loader2, ChevronDown, SearchIcon, User, Phone, BadgeIndianRupee, Calendar, Clock  } from 'lucide-react'
        ...
        <div className={serviceAppointmentsStyles.headerContainer}>
                    ...
                    <label className={serviceAppointmentsStyles.searchLabel}>
                        ...
                        <div className='flex items-center gap-2 relative w-full'>
                            ...
                            {search ? (
                              ...
                              >
                                <XCircle className={serviceAppointmentsStyles.clearSearchIcon} />
                              </button>
                            ): null }
                        </div>
                    </label>
            ...
            >
              ...
              <option value="Canceled">Canceled</option>
                ...
                className={serviceAppointmentsStyles.refreshButton}></button>
            </div>
        </div>
        {loading ? (
            ...
            <div className={serviceAppointmentsStyles.gridContainer}>
                {displayList.length === 0 ? (
                    <div className={serviceAppointmentsStyles.noResultsContainer}>
                        ...
                        <div className={`${serviceAppointmentsStyles.noResultsText} text-center`}>No Appointments match your search
                            <div className={serviceAppointmentsStyles.noResultsSubtext}>
                                Try a different method, name or service 
                            </div>
                        </div>
                    </div>
                ):(
