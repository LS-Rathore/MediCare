...
import { AlertTriangle, CheckCircle, Image, Plus, Trash2, Calendar, Clock, XCircle } from 'lucide-react';
...
const AddService = ({serviceId}) => {
  ...
  // fetch services in editing stage 
   useEffect(() => {
    let mounted = true;
  ...
  return (
    <div className={addServiceStyles.container.main}>
        ...
        <form onSubmit={handleSubmit} className={addServiceStyles.container.form}>
            <div className='flex flex-col sm:flex-row item-start sm:item-center 
