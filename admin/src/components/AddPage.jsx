...
import { EyeClosed, User, XCircle, Eye, Calendar,Plus,Trash, CheckCircle } from 'lucide-react'
        ...
        <div className={s.pageContainer}>
          ...
          <input className={s.inputBase} 
                        ...
                        setForm({
                            ...
                            rows={3} placeholder='About Doctor' value={form.about} 
                            onChange={(e)=> setForm({
                                ...form,
