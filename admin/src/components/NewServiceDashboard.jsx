...
import { BadgeIndianRupee, ClipboardList, XCircle, Calendar, CheckCircle, Search } from "lucide-react";
import { API_BASE } from "../config";


// normaize the backend data that is coming from DB
            ...
            <div className={serviceDashboardStyles.innerContainer}>
                ...
                <div className={serviceDashboardStyles.header.container}>
                    <div>
                        ...
                        <p className={serviceDashboardStyles.header.subtitle}>
                            Overview of services, appointment statistics and revenue                           
                        </p>
                    </div>
                    {/*Refresh*/}
                ...
                <div className={serviceDashboardStyles.search.container}>
                    <div className={serviceDashboardStyles.search.inputContainer}>
                        <Search size={16} className="ext-emerald-700" />
...
function StatCard({icon, label, value}) {
    return (
        <div className={serviceDashboardStyles.statCard.container}>
            ...
            <div>
                <div className={serviceDashboardStyles.statCard.labelContainer}>{label}</div>
