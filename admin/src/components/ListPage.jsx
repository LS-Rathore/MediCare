...
import { Users, Search, Sliders,Star, EyeClosed,Trash2, IndianRupee } from 'lucide-react';
      ...
      <div className={doctorListStyles.container}>
        <header className={doctorListStyles.headerContainer}>
          <div className={doctorListStyles.headerTopSection}>
            <div className={doctorListStyles.headerIconContainer}>
              ...
              <div>
                <h1 className={doctorListStyles.headerTitle}>Manage Doctors</h1>
        ...
        <main className={doctorListStyles.gridContainer}>
          ...
          {displayed.map((doc) =>{
           ...
           return (
            <article key={id} className={`${doctorListStyles.article} ${isOpen ? 'lg:col-span-2 xl:col-span-2' : ''}`}>
