...
import {Calendar, Medal, MousePointer2Off,ChevronRight} from 'lucide-react'
            ...
            {doctors.slice(0, previewCount).map((doctor)=> (
              <article key={doctor.id || doctor.name} className={homeDoctorsStyles.article}>
                ...
                <div className={homeDoctorsStyles.cardBody}>
                  <h3 id={`doctor-${doctor.id}-name`} className={homeDoctorsStyles.doctorName}>
                    {doctor.name}
                  </h3>
                  ...
                  <div className={homeDoctorsStyles.buttonContainer}>
                    <div className={"w-full"}>
                      {doctor.available ? (
                        ...
                        <button className={homeDoctorsStyles.buttonUnavailable}>
