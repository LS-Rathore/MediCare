...
// Moved outside Testimonial to prevent re-creation on every render
  ...
  return (
   <div className={testimonialStyles.container}>
    <div className={testimonialStyles.headerContainer}>
        ...
        <p className={testimonialStyles.subtitle}>Hear what our doctors and patients have to say about our platform</p>
    </div>
    <div className={`${testimonialStyles.grid} testimonial-grid`}>
        ...
        <div className={`${testimonialStyles.columnContainer} ${testimonialStyles.leftColumnBorder}`}>
            ...
            <div className={testimonialStyles.scrollContainer}>
                <div className="scroll-track scroll-up">
        ...
        <div className={`${testimonialStyles.columnContainer} ${testimonialStyles.rightColumnBorder}`}>
            ...
            <div className={testimonialStyles.scrollContainer}>
                <div className="scroll-track scroll-down">
