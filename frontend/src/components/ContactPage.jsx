...
import {User, Mail, Phone, MapPin, Stethoscope, MenuSquare, SendHorizonal, Calendar, Clock,} from "lucide-react";
...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/0000001234?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.pageContainer}>
                ...
                <div className={contactPageStyles.formContainer}>
                    ...
                    <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
                        <div className={contactPageStyles.formGrid}>
                            ...
                            placeholder="Enter your full name" className={contactPageStyles.input} />
                            {errors.name && (
            ...
            <div className={contactPageStyles.formGrid}>
              ...
              <div className={contactPageStyles.buttonContainer}>
                ...
                {sent && <p className={contactPageStyles.sentMessage}>
