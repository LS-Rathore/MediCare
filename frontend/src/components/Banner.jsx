...
import { Stethoscope, Star, Ribbon, Clock, Users, ShieldUser, Calendar, Phone } from 'lucide-react'
                    ...
                    <div className={bannerStyles.leftContent}>
                        ...
                        <div className={bannerStyles.featuresGrid}>
                            <div className={`${bannerStyles.featureItem} ${bannerStyles.featureBorderGreen}`}>
                                ...
                                <span className={bannerStyles.featureText}>Trusted by thousands</span>
                            </div>
                            ...
                            <div className={`${bannerStyles.featureItem} ${bannerStyles.featureBorderPurple}`}>
                                ...
                                <span className={bannerStyles.featureText}>Qualified Doctors</span>
                            </div>
                        </div>
                        <div className={bannerStyles.ctaButtonsContainer}>
                            ...
                            <button onClick={() => (window.location.href = "tel:0000000000")} 
