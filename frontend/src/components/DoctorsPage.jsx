...
import { ChevronRight, Search, X, Medal, MousePointer2Off, CircleChevronUp, CircleChevronDown } from 'lucide-react';
      ...
      <div className={doctorsPageStyles.wrapper}>
        <div className={doctorsPageStyles.headerContainer}>
          <h1 className={doctorsPageStyles.headerTitle}>
            ...
            Browse the profiles of our highly qualified medical professionals and find the perfect match for your healthcare needs.
              </p>
        </div>
              ...
              displayedDoctors.map((doctor, index ) => (
                ...
                style={{
                  ...
                  <div className={doctorsPageStyles.experienceBadge}>
                    <Medal className={doctorsPageStyles.expIcon} />
                    <span>
