...
const ListPage = ({ columns, rows }) => {
  ...
  const filtered = useMemo(() => {
    return [...appointments]
      ...
      .sort(
        (a, b) => parseDateTime(b.date, b.time).getTime() - parseDateTime(a.date, a.time).getTime(),
      );
            ...
            <div className={listPageStyles.contentWrapper}>
                <div className={listPageStyles.headerContainer} >
                    ...
                    <p className={listPageStyles.headerSubtitle}>
                        Latest on top - search by patient name
                    </p>
                    </div>
