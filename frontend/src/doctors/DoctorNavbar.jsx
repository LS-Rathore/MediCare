...
import {Calendar, Home, Edit, Menu, LogOut, X} from "lucide-react"
  ...
  <>
        ...
        <div className={navbarStylesDr.leftBrand}>
            ...
            <div className={navbarStylesDr.brandTextContainer}>
                ...
                <div className={navbarStylesDr.brandSubtitle}>Health & Wellness Center
                </div>
            </div>
        </div>
        {/* dekstop nav */}
        ...
        <div className={navbarStylesDr.rightActions}>
            <button onClick={() => window.location.href = '/doctor-admin/login'} 
